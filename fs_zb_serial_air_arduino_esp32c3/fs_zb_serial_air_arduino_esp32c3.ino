...
// Pin definitions
#define SERVO_PIN 2    // GPIO2 for steering servo
#define ESC_PIN 3      // GPIO3 for ESC throttle
...
void setup() {
  ...
  Serial0.println("RC Car Controller (ESP32-C3) Initialized");
  ...
  Serial0.println("Servos attached and initialized");
}
...
void processCommand(char* command) {
  ...
  if (sIndex >= 0 && tIndex > sIndex) {
    ...
    // Send confirmation
    // Serial0.print("OK:S");
    // Serial0.print(steeringValue);
    // Serial0.print("T");
    // Serial0.println(throttleValue);
