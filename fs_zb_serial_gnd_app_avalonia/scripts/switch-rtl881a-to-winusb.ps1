param(
    ...
    [string]$InfPath = "C:\Windows\INF\oem67.inf"
)
...
if (-not $isElevated) {
    throw "Run this script from an elevated PowerShell session. It force-switches the device driver to WinUSB."
}
...
Write-Host "Successfully switched $HardwareId to WinUSB using $InfPath"
